  ...
  return (
    <header ref={ref}>
      ...
      >
        <h3>
          <a
            href="https://github.com/mil0libby"
            target={"_blank"}
      ...
      >
        <div>
          ...
          <p className="theme--detail">
            <ScrambleText shuffle delay={4}>
              Hello, I’m Milo, I tackle complex engineering challenges daily. My
              mission is to continuously advance in web development, using my
      ...
      <h1 className="header--name">
        <TextWriting controls={controls} text={"Milo Libby"} noblink />
        <br />
        <TextWriting
          controls={controls}
          delay={1.65}
